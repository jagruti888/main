...
<section class="breadcumb-area bg-img d-flex align-items-center justify-content-center"
  ...
  <div class="bradcumbContent" style="position: relative; z-index: 2;">
    <h2 style="color: white;">Contact's Records</h2>
  </div>
</section>
        ...
        while ($row = mysqli_fetch_array($re))
         {
            echo "<tr>
                    ...
                    <td>{$row['mobile']}</td>
                    <td>{$row['message']}</td>
                    <td class='edit-btn'><a href='ad_edit_contact.php?uid={$row['id']}'><img src='edit.png' alt='Edit'></a></td>
                    <td class='delete-btn'><a href='ad_delete_contact.php?uid={$row['id']}'><img src='drop.png' alt='Delete'></a></td>
                </tr>";
        }
